...
<html>
    ...
    <body>
        ...
        <div style="display: flex; justify-content: space-between;">
            ...
            <a style="text-align: center;">    Dispose an Asset</a><br>
        ...
        <h2 style="text-align: center;">Dispose Asset</h2>
        <form name="Asset Info" action="Action_Asset_Dispose.jsp" method="POST" style="text-align: center">
            <div style="display: flex; justify-content: center;">
                <div style="border: 1px solid black; padding: 20px;">
                Asset ID: 
                <select name="asset_id" id="asset_id"> 
                    <% for (Assets a : aBean.getAssetList("status", "X", false)) {%>
